...
if __name__ == "__main__":
    ...
    print(f"Final allele frequencies after {generations} generations:")
    print(f"  p_A: {p_A_values[-1]:.4f}")
    print(f"  handicap allele: {p_B_values[-1]:.4f}")
    print(f"  preference allele: {p_C_values[-1]:.4f}")
